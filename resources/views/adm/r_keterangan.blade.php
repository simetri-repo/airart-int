...
<div class="container-fluid py-4">
   <div class="row">
      ...
      <div class="card">
         <div class="card-body">
            <h5 class="card-title">R_Keterangan</h5>
               ...
               <table id="dt_table" class="display table table-striped" style="width:100%">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td><a href="{{ url('hapus_keterangan/'. $item->id_keterangan)}}" class="text-danger"
   ...
   <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">Tambah Keterangan</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
         </div>
         <form action="{{ url('new_keterangan') }}" method="post">
            @csrf
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="input-group input-group-outline my-3">
                     ...
                     <input type="text" name="input-in" class="form-control">
                  </div>
               </div>
            </div>
         </div>
