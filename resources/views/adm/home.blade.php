...
<div class="container-fluid py-4">
   ...
   <div class="row">
      ...
      {{-- --}}
      <div class="col-xl-6 col-sm-12 mb-xl-0 mb-4 col-md-6">
         <div class="card">
            <div class="card-header p-3 pt-2">
               <div
      ...
      {{-- --}}
      <div class="col-xl-2 col-sm-12 mb-xl-0 mb-4 col-md-2">
         <div class="card">
            <div class="card-header p-3 pt-2">
               <div
               ...
               <div class="text-end pt-1">
                  <p class="text-sm mb-0 text-capitalize">Total PIC</p>
                  <h4 class="mb-0">{{ $jml_pic }}</h4>
               </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
               <div class="text-center">
                  <p class="mb-0"><span class="text-success text-sm font-weight-bolder"> {{ $jml_user_on }}</span>
                     Online
                  </p>
               </div>
            </div>
      ...
      <div class="list-wrapper">
         <div class="col-lg-12 row pt-4">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 mt-0 list-item">
               <div class="content">
